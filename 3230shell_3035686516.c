 ...
 * Development Platform: MacOS and Ubuntu docker container
 * Remark: Complete all features except timeX 
           - Basic commands: ls, ps, ps -f, clear, cd, pwd, exit and interactive shell
           - Process creation and execution - foreground
           - Process creation and exection with piplining- use of '|'
           - Use of signals 
           - Bonus: SIGCHLD signal
           - Bonus: Process creation and execution with '&'- background
